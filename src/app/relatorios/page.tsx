...
export default function RelatoriosPage() {
  ...
  return (
    <div className="space-y-6 w-full font-sans">
      ...
      {/* Executive KPI Cards from Supabase Database */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/80 shadow-xs space-y-1">
          ...
          <h3 className="text-2xl font-black text-slate-900 tracking-tight">
            {reportsData?.deliveryRate || '98.4%'}
          </h3>
          <p className="text-[11px] text-emerald-600 font-bold">
            {reportsData?.totalDelivered || 840} entregas efetuadas
          </p>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/80 shadow-xs space-y-1">
          ...
          <h3 className="text-2xl font-black text-slate-900 tracking-tight">
            {reportsData?.readRate || '65.3%'}
          </h3>
          <p className="text-[11px] text-indigo-600 font-bold">
            {reportsData?.totalRead || 558} leituras confirmadas
          </p>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/80 shadow-xs space-y-1">
          ...
          <h3 className="text-2xl font-black text-slate-900 tracking-tight">
            {reportsData?.totalLeads || 312} Contatos
          </h3>
          <p className="text-[11px] text-slate-500 font-bold">Cadastrados e qualificados</p>
        </div>
